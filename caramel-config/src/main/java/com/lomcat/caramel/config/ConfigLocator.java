...
class ConfigLocator {
    ...
    static Map<String, List<ConfigResourceBunch>> locate(String[] locations, CaramelConfigPosition[] positions) {
    ...
    /**
     * <p>
     *     根据 {@link CaramelConfigPosition} 集合创建配置文件集 {@link ConfigResourceBunch} 的集合，
     ...
     * </p>
     */
    private static Map<String, List<ConfigResourceBunch>> resolveConfigResourceBunches(List<CaramelConfigPosition> positions) {
